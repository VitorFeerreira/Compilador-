...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_ou = 260,                  /* TOK_ou  */
    TOK_si = 261,                  /* TOK_si  */
    TOK_sinaum = 262,              /* TOK_sinaum  */
    TOK_repete = 263,              /* TOK_repete  */
    TOK_Igual = 264,               /* TOK_Igual  */
    TOK_Diferente = 265,           /* TOK_Diferente  */
    TOK_MenorQ = 266,              /* TOK_MenorQ  */
    TOK_MaiorQ = 267,              /* TOK_MaiorQ  */
